...
function openDB(filePath=":memory:"){
  ...
  db.exec(`CREATE TABLE IF NOT EXISTS automation_runs(id INTEGER PRIMARY KEY AUTOINCREMENT,run_label TEXT NOT NULL,source TEXT NOT NULL,step TEXT NOT NULL,result TEXT NOT NULL,status TEXT NOT NULL,created_at TEXT NOT NULL DEFAULT(datetime('now')),UNIQUE(run_label,source,step))`);
  return db;
}
